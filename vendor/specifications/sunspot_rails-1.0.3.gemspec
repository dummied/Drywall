...
Rails request.
  ...
  s.files = ["MIT-LICENSE", "Rakefile", "README.rdoc", "TODO", "History.txt", "VERSION.yml", "LICENSE", "lib/sunspot/rails/spec_helper.rb", "lib/sunspot/rails/searchable.rb", "lib/sunspot/rails/version.rb", "lib/sunspot/rails/stub_session_proxy.rb", "lib/sunspot/rails/adapters.rb", "lib/sunspot/rails/configuration.rb", "lib/sunspot/rails/server.rb", "lib/sunspot/rails/tasks.rb", "lib/sunspot/rails/request_lifecycle.rb", "lib/sunspot/rails/solr_logging.rb", "lib/sunspot/rails.rb", "dev_tasks/gemspec.rake", "dev_tasks/todo.rake", "dev_tasks/rdoc.rake", "dev_tasks/release.rake", "generators/sunspot/sunspot_generator.rb", "generators/sunspot/templates/sunspot.yml", "install.rb", "rails/init.rb", "spec/spec_helper.rb", "spec/session_spec.rb", "spec/stub_session_proxy_spec.rb", "spec/server_spec.rb", "spec/configuration_spec.rb", "spec/model_lifecycle_spec.rb", "spec/schema.rb", "spec/model_spec.rb", "spec/request_lifecycle_spec.rb", "spec/mock_app/app/controllers/posts_controller.rb", "spec/mock_app/app/controllers/application_controller.rb", "spec/mock_app/app/controllers/application.rb", "spec/mock_app/app/models/location.rb", "spec/mock_app/app/models/photo_post.rb", "spec/mock_app/app/models/blog.rb", "spec/mock_app/app/models/post_with_auto.rb", "spec/mock_app/app/models/author.rb", "spec/mock_app/app/models/post.rb", "spec/mock_app/db/schema.rb", "spec/mock_app/db/test.db", "spec/mock_app/config/database.yml", "spec/mock_app/config/environment.rb", "spec/mock_app/config/initializers/session_store.rb", "spec/mock_app/config/initializers/new_rails_defaults.rb", "spec/mock_app/config/sunspot.yml", "spec/mock_app/config/environments/development.rb", "spec/mock_app/config/environments/test.rb", "spec/mock_app/config/routes.rb", "spec/mock_app/config/boot.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_dependency(%q<sunspot>, ["= 1.0.3"])
